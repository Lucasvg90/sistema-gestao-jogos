...
@Component({
  selector: 'app-consultar-jogo',
  standalone: true, 
  imports: [FormsModule, CommonModule],
  templateUrl: './consultar-jogo.component.html',
  styleUrls: ['./consultar-jogo.component.css']
})
export class ConsultarJogoComponent {
      ...
      this.jogosService.buscarPorId(id).subscribe({
        next: (jogo) => {
          if (jogo) {
            ...
            this.erroBusca = 'Jogo não localizado';
          }
        },
        error: () => {
          this.erroBusca = 'Erro ao buscar o jogo';
        }
      });
    }
  }
